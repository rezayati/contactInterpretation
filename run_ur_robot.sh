...
cmd1="source $(conda info --base)/etc/profile.d/conda.sh; conda init bash; conda activate frankapyenv; source /opt/ros/noetic/setup.bash; $HOME/miniconda/envs/frankapyenv/bin/python3 urRobot/mainUR5_v2.py < /tmp/shared_input1"
cmd2="source $(conda info --base)/etc/profile.d/conda.sh; conda init bash; conda activate frankapyenv; source /opt/ros/noetic/setup.bash; $HOME/miniconda/envs/frankapyenv/bin/python dataLabeling/digitalGloveNodeUSB.py"
cmd3="source $(conda info --base)/etc/profile.d/conda.sh; conda init bash; conda activate frankapyenv; source /opt/ros/noetic/setup.bash; $HOME/miniconda/envs/frankapyenv/bin/python3 urRobot/saveDataNode.py < /tmp/shared_input2"
